...
defineProps<{ state: LoadingState }>()
...
<template>
  <div id="loading-container">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="80" height="80"
      ...
      <!-- 锤子敲击后出现的三角形 -->
      <g class="triangles" opacity="0.7" fill="currentColor" v-if="state == 'loading'">
      ...
      <!-- 叉叉 -->
      <g fill="currentColor" v-if="state == 'error'">
        <path
...
.hamer {
  ...
  animation: hamerAnim 2s infinite ease-in-out;
}
